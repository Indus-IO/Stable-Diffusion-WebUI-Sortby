...
def get_checkpoint_state_dict(checkpoint_info: CheckpointInfo, timer):
    ...
    name, extension = os.path.splitext(os.path.basename(checkpoint_info.filename))#added
    
    result = [x for x in fileData if x not in os.path.basename(name)]#added
    result.append(os.path.basename(name))#added
